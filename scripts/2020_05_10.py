...
def import_data():
    ...
    courses_city_3.name_ru = 'Вашингтон'
    ...
    courses_city_5.name_ru = 'Стокгольм'
    ...
    courses_courselevel_1.name_ru = 'Начинающий'
    ...
    courses_courselevel_2.name_ru = 'Средний'
    ...
    courses_courselevel_3.name_ru = 'Продвинутый'
    ...
    courses_courseage_1.name_ru = 'Младенцы (0-3 лет)'
    ...
    courses_courseage_2.name_ru = 'Дошкольники (4-6 лет)'
    ...
    courses_courseage_3.name_ru = 'Дети (7-12 лет)'
    ...
    courses_courseage_4.name_ru = 'Подростки (13-17 лет)'
    ...
    courses_courseage_5.name_ru = 'Взрослые (18-64 лет)'
    ...
    courses_courseage_6.name_ru = 'Пожилые (65+ лет)'
    ...
    courses_coursearea_1.name_ru = 'Математика'
    ...
    courses_coursearea_2.name_ru = 'Физика'
    ...
    courses_coursearea_3.name_ru = 'Химия'
    ...
    courses_coursearea_4.name_ru = 'Биология'
    ...
    courses_courselanguage_1.name_ru = 'Английский'
    ...
    courses_courselanguage_2.name_ru = 'Французский'
    ...
    courses_courselanguage_3.name_ru = 'Арабский'
    ...
    courses_courselanguage_4.name_ru = 'Испанский'
    ...
    courses_courselanguage_5.name_ru = 'Японский'
    ...
    courses_courselanguage_6.name_ru = 'Хинди'
    ...
    courses_courselanguage_7.name_ru = 'Русский'
    ...
    courses_courselocationtype_1.name_ru = 'У учителя'
    ...
    courses_courselocationtype_2.name_ru = 'У студента'
    ...
    courses_courselocationtype_3.name_ru = 'По вебкамере'
    ...
    profiles_user_1.password = 'pbkdf2_sha256$180000$cwXsrztq2kJE$S0uNCeGQ+FvIIi/LlodoNOIBkurUaDpFLoPpstMEetA='
    ...
    profiles_user_2.password = 'pbkdf2_sha256$180000$jQbED5mRC3FC$rGHmLPbEnbCrOGGHpIxdbpEjAWH76Dj4auzItGjxy3Y='
    ...
    profiles_user_3.password = 'pbkdf2_sha256$180000$GPo9wAK6xKK7$NERotmMpKK7hKesccmfbreFEjUBtlB+iMk1n1lR/mvc='
    ...
    profiles_review_1.content_type = ContentType.objects.get(app_label="profiles", model="professor")
    ...
    profiles_review_2.content_type = ContentType.objects.get(app_label="profiles", model="professor")
    ...
    profiles_review_3.content_type = ContentType.objects.get(app_label="profiles", model="professor")
    ...
    profiles_user_1.groups.add(  importer.locate_object(Group, "id", Group, "id", 2, {'id': 2, 'name': 'professors'} )  )


    profiles_user_3.groups.add(  importer.locate_object(Group, "id", Group, "id", 1, {'id': 1, 'name': 'students'} )  )
