...
def import_data():
    ...
    auth_permission_77.name = 'Access professor pages'
    auth_permission_77.content_type = ContentType.objects.get(app_label="profiles", model="user")
    auth_permission_77.codename = 'access_professor_pages'
    auth_permission_77 = importer.save_or_locate(auth_permission_77)

    auth_permission_78 = Permission()
    auth_permission_78.name = 'Access student pages'
    auth_permission_78.content_type = ContentType.objects.get(app_label="profiles", model="user")
    auth_permission_78.codename = 'access_student_pages'
    ...
    auth_group_2.permissions.add(auth_permission_78)
